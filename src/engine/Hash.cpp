...
#include "engine/XXHash64.h"

#include "trezor/blake256.h"
#include "trezor/blake2b.h"
#include "trezor/groestl.h"
...
Data Hash::sha1(const TW::byte* data, size_t size)
{
...
Data Hash::sha256(const TW::byte* data, size_t size)
{
...
Data Hash::sha512(const TW::byte* data, size_t size)
{
...
Data Hash::sha512_256(const TW::byte* data, size_t size)
{
    Data result(sha256Size);
...
Data Hash::keccak256(const TW::byte* data, size_t size)
{
    Data result(sha256Size);
...
Data Hash::keccak512(const TW::byte* data, size_t size)
{
    Data result(sha512Size);
...
Data Hash::sha3_256(const TW::byte* data, size_t size)
{
    Data result(sha256Size);
...
Data Hash::sha3_512(const TW::byte* data, size_t size)
{
    Data result(sha512Size);
...
Data Hash::ripemd(const TW::byte* data, size_t size)
{
...
Data Hash::blake256(const TW::byte* data, size_t size)
{
    Data result(sha256Size);
...
Data Hash::blake2b(const TW::byte* data, size_t dataSize, size_t hashSize)
{
...
Data Hash::blake2b(const TW::byte* data, size_t dataSize, size_t hashSize, const Data& personal)
{
    Data result(hashSize);
...
Data Hash::groestl512(const TW::byte* data, size_t size)
{
    GROESTL512_CTX ctx;
    Data result(sha512Size);
    groestl512_Init(&ctx);
...
uint64_t Hash::xxhash(const TW::byte* data, size_t size, uint64_t seed)
{
    return XXHash64::hash(data, size, seed);
}

Data Hash::xxhash64(const TW::byte* data, size_t size, uint64_t seed)
{
...
Data Hash::xxhash64concat(const TW::byte* data, size_t size)
{
