...
#include "engine/PrivateKey.h"

#include "engine/PublicKey.h"
...
#include "trezor/schnorr.h"
#include "trezor/secp256k1.h"
#include "trezor/sodium/keypair.h"
...
Data PrivateKey::signAsDER(const Data& digest, TWCurve curve) const
{
    ...
    Data resultBytes(72);
    size_t sig_size = ecdsa_sig_to_der(sig.data(), resultBytes.data());
