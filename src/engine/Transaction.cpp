...
#include "engine/SegwitAddress.h"
#include "engine/SigHashType.h"

#include "engine/SignatureVersion.h"
                                       ...
                                       enum TWBitcoinSigHashType hashType) const
{
    ...
    for (size_t subindex = 0; subindex < serializedInputCount; subindex += 1) {
    ...
    for (size_t subindex = 0; subindex < serializedOutputCount; subindex += 1) {
